    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            if (true)
            {
                ...
                Predicate<Game> testPredicate = (a) => { return a.player.location != a.dungeon.exitNode; };
                bool test = reader.replay(new Utils.Specification( testPredicate));
            ...
            else
            {
                ...
                ReplayWriter.InitializeReplaySystem("default", seed, difficultyLevel, nodeCapacityMultiplier, numberOfMonsters);
